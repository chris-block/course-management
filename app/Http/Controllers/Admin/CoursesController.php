...
class CoursesController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $teachers = \App\User::get()->pluck('name', 'id');
$lessons = \App\Lesson::where('course_id', $id)->get();$tests = \App\Test::where('course_id', $id)->get();$sections = \App\Section::where('course_id', $id)->get();

        $course = Course::findOrFail($id);

        return view('admin.courses.show', compact('course', 'lessons', 'tests', 'sections'));
    }
