...
class LessonsController extends Controller
{
    ...
    public function create()
    {
        ...
        $sections = \App\Section::get()->pluck('title', 'id')->prepend(trans('quickadmin.qa_please_select'), '');
    ...
    public function show($id)
    {
        ...
        $courses = \App\Course::get()->pluck('title', 'id')->prepend(trans('quickadmin.qa_please_select'), '');
        $sections = \App\Section::get()->pluck('title', 'id')->prepend(trans('quickadmin.qa_please_select'), '');$tests = \App\Test::where('lesson_id', $id)->get();
