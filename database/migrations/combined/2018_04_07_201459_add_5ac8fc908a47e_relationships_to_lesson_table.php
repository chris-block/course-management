...
class Add5ac8fc908a47eRelationshipsToLessonTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('lessons', function(Blueprint $table) {
            if(Schema::hasColumn('lessons', 'course_id')) {
                $table->dropForeign('141604_5ac8ed7943951');
                $table->dropIndex('141604_5ac8ed7943951');
                $table->dropColumn('course_id');
            }
            if(Schema::hasColumn('lessons', 'section_id')) {
                $table->dropForeign('141604_5ac8fc8c0c7b7');
                $table->dropIndex('141604_5ac8fc8c0c7b7');
